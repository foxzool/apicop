...
describe APICop::OAuth2::AccessToken::MAC::Signature do
  ...
  context 'when ext is not given' do
    ...
    it { expect(subject.calculate).to eq 'OZE9fTk2qiRtL1jb01L8lRxC66PTiAGhMDEmboeVeLs=' }
  end
  ...
  context 'when ext is not given' do
    ...
    it { expect(subject.calculate).to eq '6T3zZzy2Emppni6bzL7kdRxUWL4=' }
  end
  ...
  context 'otherwise' do
    ...
    it { expect(subject.calculate).to eq '+txL5oOFHGYjrfdNYH5VEzROaBY=' }
  end
