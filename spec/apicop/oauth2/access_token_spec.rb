  ...
  [:get, :delete, :post, :put].each do |method|
    describe method do
      it 'should delegate to HTTPClient with Authenticator filter' do
        ...
        token.httpclient.request_filter.last.should be_a APICop::OAuth2::AccessToken::Authenticator
    ...
    context 'in debug mode' do
      it do
        APICop::OAuth2.debug do
          ...
          token.httpclient.request_filter.last.should be_a APICop::OAuth2::Debugger::RequestFilter
        end
      end
    end
  end
