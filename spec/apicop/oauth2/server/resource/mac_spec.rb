...
describe APICop::OAuth2::Server::Resource::MAC do
  let(:app) do
    APICop::OAuth2::Server::Resource::MAC.new(simple_app) do |request|
  ...
  let(:mac_token) do
    APICop::OAuth2::AccessToken::MAC.new(
  ...
  let(:access_token) { env[APICop::OAuth2::Server::Resource::ACCESS_TOKEN] }
  ...
  shared_examples_for :unauthorized_mac_request do
    it 'should be unauthorized' do
      status, header, _response = request
  ...
  shared_examples_for :bad_mac_request do
    it 'should be unauthorized' do
      status, _header, _response = request
  ...
  context 'when invalid_token is given' do
    ...
    describe 'realm' do
      ...
      context 'when specified' do
        ...
        let(:app) do
          APICop::OAuth2::Server::Resource::MAC.new(simple_app, realm) do |request|
      ...
      context 'otherwize' do
        it 'should use default realm' do
          ...
          expect(header['WWW-Authenticate']).to include "MAC realm=\"#{APICop::OAuth2::Server::Resource::DEFAULT_REALM}\""
        end
      end
    end
  end
