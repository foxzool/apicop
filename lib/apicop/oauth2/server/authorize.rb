...
require 'apicop/oauth2/server/authorize/code'
require 'apicop/oauth2/server/authorize/token'
require 'apicop/oauth2/server/authorize/extension'
require 'apicop/oauth2/server/authorize/error'
