  ...
  module OAuth2
    module Server
      class Token < Abstract::Handler
        ...
        rescue APICop::OAuth2::Server::Abstract::Error => e
          e.finish
        end
...
require 'apicop/oauth2/server/token/authorization_code'
require 'apicop/oauth2/server/token/password'
require 'apicop/oauth2/server/token/client_credentials'
require 'apicop/oauth2/server/token/refresh_token'
require 'apicop/oauth2/server/token/extension'
require 'apicop/oauth2/server/token/error'
