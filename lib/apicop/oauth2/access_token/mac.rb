    ...
    class AccessToken
      class MAC < AccessToken
        ...
        def verify!(request)          
          ...
          raise APICop::OAuth2::AccessToken::MAC::Verifier::VerificationFailed.new("Request ts expired") if now - request.ts.to_i > @ts_expires_in.to_i
...
require 'apicop/oauth2/access_token/mac/verifier'
require 'apicop/oauth2/access_token/mac/sha256_hex_verifier'
require 'apicop/oauth2/access_token/mac/signature'
